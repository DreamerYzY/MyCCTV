...
public class OtherListAdapter extends BaseAdapter {
    ...
    public OtherListAdapter(Context context, List<OtherBean.DataBean.ItemListBean> itemList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        OtherBean.DataBean.ItemListBean itemListBean = itemList.get(position);
